...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { asistentes: @concert.asistentes, duration: @concert.duration, event_date: @concert.event_date, name: @concert.name } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { asistentes: @concert.asistentes, duration: @concert.duration, event_date: @concert.event_date, name: @concert.name } }
